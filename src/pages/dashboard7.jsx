...
export default function MiniDrawer() {
  ...
  const backups = [
    { deviceName: 'Device Name G700-1', sqlFileName: 'pd_files', lastBackup: 'June 26, 2024' },
    { deviceName: 'Device Name G700-1', sqlFileName: 'pd_files', lastBackup: 'June 26, 2024' },
    { deviceName: 'Device Name G700-1', sqlFileName: 'pd_files', lastBackup: 'June 26, 2024' },
    { deviceName: 'Device Name G700-1', sqlFileName: 'pd_files', lastBackup: 'June 26, 2024' },
    { deviceName: 'Device Name G700-1', sqlFileName: 'pd_files', lastBackup: 'June 26, 2024' },
      ...
      <AppBar position="fixed" open={open} sx={{ backgroundColor: '#EBF6F0' }}>
        <Toolbar>
          ...
          <IconButton className='icon-btn'>
            <NotificationsIcon sx={{ fontSize: 30, color: 'inherit' }} />
          </IconButton>
          <IconButton className='icon-btn'>
            ...
            <ListItem key={item.text} disablePadding sx={{ display: 'block' }}>
              <ListItemButton
                ...
                sx={{
                  ...
                  color: activeTab === item.text ? 'blue' : 'grey',
                  '&:hover': {
          ...
          <>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', width: '80%'}}>
              <Box sx={{ display: 'flex', gap: 2 }}>
                <Button variant="contained" color="success" sx={{ fontSize: 16, padding: '6px 12px' }}>
                  Backup
                </Button>
                <Button variant="contained" color="primary" sx={{ fontSize: 16, padding: '6px 12px' }}>
                  Restore
                </Button>
              </Box>
            </Box>
            <TableContainer component={Paper} sx={{ marginTop: 3, width: '80%'}}>
              <Table>
                <TableHead>
                  <TableRow>
                    <TableCell sx={{ backgroundColor: 'rgba(180, 223, 205, 0.5)' }}>Device name</TableCell>
                    <TableCell sx={{ backgroundColor: 'rgba(180, 223, 205, 0.5)' }}>SQL File name</TableCell>
                    <TableCell sx={{ backgroundColor: 'rgba(180, 223, 205, 0.5)' }}>Last backup</TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  {backups.map((backup, index) => (
                    <TableRow key={index}>
                      ...
                      <TableCell>{backup.sqlFileName}</TableCell>
